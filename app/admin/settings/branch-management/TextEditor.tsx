      ...
      <div className="px-3 py-2 border-b dark:border-gray-600">
        <div className="flex flex-wrap items-center space-x-1">
          ...
          <button
            ...
            className={`p-1.5 rounded cursor-pointer ${isBold ? 'text-blue-500' : 'text-gray-500'
          ...
          <button
            ...
            className={`p-1.5 rounded cursor-pointer ${isItalic ? 'text-blue-500' : 'text-gray-500'
              } hover:text-gray-900 dark:hover:text-white`} >
            <svg
              className="w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            ...
            className={`p-1.5 rounded cursor-pointer ${isUnderline ? 'text-blue-500' : 'text-gray-500'
              } hover:text-gray-900 dark:hover:text-white`} >
            <svg
              className="w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            ...
            className={`p-1.5 rounded cursor-pointer ${isStrikethrough ? 'text-blue-500' : 'text-gray-500'
              } hover:text-gray-900 dark:hover:text-white`}  >
            <svg
              className="w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            ...
            className={`p-1.5 rounded cursor-pointer ${isBlockquote ? 'text-blue-500' : 'text-gray-500'
              } hover:text-gray-900 dark:hover:text-white`} >
            <svg
              className="w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            ...
            className={`p-1.5 rounded cursor-pointer ${isCode ? 'text-blue-500' : 'text-gray-500'
              } hover:text-gray-900 dark:hover:text-white`}  >
            <svg
              className="w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
