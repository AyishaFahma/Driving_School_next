...
const Admission = () => {
  ...
  //state to store single data for view
  const [singleData, setsingleData] = useState<any>(null)

  // Function to open modal with data for view
  ...
  // Function to close modal for view
 ...
 // function to get all admission data
  ...
  const fetchSearchBranch = async () => {
    try {
      ...
      const data = await response.json();
      console.log("All branch data", data.data);
  ...
  // search branch in dropdown for filtering
  ...
  //button for only for fee to be paid
